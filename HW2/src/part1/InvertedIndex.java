...
public class InvertedIndex {
	...
	public void phase1(String inputPath, String outputPath) throws IOException {
		...
		conf.setMapOutputKeyClass(WordFilePair.class);
		conf.setMapOutputValueClass(WordEntry.class);

		conf.setOutputKeyClass(WordFilePair.class);
		conf.setOutputValueClass(WordEntry.class);
